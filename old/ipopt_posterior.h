...
#ifndef __IPOPT_POSTERIOR_H__
#define __IPOPT_POSTERIOR_H__
 ...
 *  IPOPT_POSTERIOR implements a C++ example of problem 71 of the
 ...
 *
 */
class IpoptPosterior : public TNLP, public ErrorEstimate
{
public:
    /** default constructor */
    size_t ndim;

    IpoptPosterior(ErrorEstimate const& error_estimate, size_t ndim);

    /** default destructor */
    virtual ~IpoptPosterior();
...
private:
    ...
    //@{
    //  IpoptPosterior();
    IpoptPosterior(const IpoptPosterior&);
    IpoptPosterior& operator=(const IpoptPosterior&);
    //@}
};
